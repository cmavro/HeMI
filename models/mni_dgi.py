...
from layers import HGCN, AvgReadout, Discriminator, Discriminator2
import torch

class MNI_DGI(nn.Module):
    def __init__(self, nb_nodes, nfeat, nhid, shid, P, act, reg):
        super(MNI_DGI, self).__init__()
        nhid = 256
        ...
        self.disc2 = Discriminator2(nhid)
    ...
    def forward(self, seq1, seq2, lbl, adjs, sparse, msk, samp_bias1, samp_bias2):
        ...
        for i in range(self.P):
            ...
            logits = self.disc2(self.sigm(self.H), h1, h2, samp_bias1, samp_bias2)
            ret += b_xent(logits,lbl)
